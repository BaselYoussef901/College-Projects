...
void AddMenus(HWND hwnd)
{
    ...
    AppendMenu(color_list, MF_STRING, 0, "RED");
    AppendMenu(color_list, MF_STRING, 1, "Green");
    AppendMenu(color_list, MF_STRING, 2, "Blue");              // colors
    AppendMenu(color_list, MF_STRING, 3, "Yellow");
    AppendMenu(color_list, MF_STRING, 4, "Black");
    AppendMenu(color_list, MF_STRING, 5, "Orange");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)color_list, "Color");

    /////////////////////////////////////
    AppendMenu(circle_list, MF_STRING, 6,"Direct");
    AppendMenu(circle_list, MF_STRING, 7,"Polar");
    AppendMenu(circle_list, MF_STRING, 8,"Iterative Polar");
    AppendMenu(circle_list, MF_STRING, 9,"MidPoint");                    //circles
    AppendMenu(circle_list, MF_STRING, 10, "MidPoint Modification");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)circle_list, "Circle");
    /////////////////////////////////////
    AppendMenu(line_list, MF_STRING, 11, "DDA");
    AppendMenu(line_list, MF_STRING, 12, "MidPoint");
    AppendMenu(line_list, MF_STRING, 13, "Parametric");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)line_list, "Lines");
    /////////////////////////////////////

    AppendMenu(Ellipse_list, MF_STRING, 14, "Direct");
    AppendMenu(Ellipse_list, MF_STRING, 15, "Polar");
    AppendMenu(Ellipse_list, MF_STRING, 16, "MidPoint");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)Ellipse_list, "Ellipse");

    AppendMenu(Quarter_list, MF_STRING, 17, "1");
    AppendMenu(Quarter_list, MF_STRING, 18, "2");
    AppendMenu(Quarter_list, MF_STRING, 19, "3");
    AppendMenu(Quarter_list, MF_STRING, 20, "4");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)Quarter_list, "Quarters");


    AppendMenu(Filling_list, MF_STRING, 21, "Filling quarter with lines");
    AppendMenu(Filling_list, MF_STRING, 22, "Filling quarter with circles");
    AppendMenu(Filling_list, MF_STRING, 23, "Filling Square with Hermit Curve");
    AppendMenu(Filling_list, MF_STRING, 24, "Filling Rectangle with Bezier Curve");
    AppendMenu(Filling_list, MF_STRING, 25, "flood fill - recursive");//flood fill
    AppendMenu(Filling_list, MF_STRING, 26, "flood fill - non recursive");//flood fill
    AppendMenu(Filling_list, MF_STRING, 27, "Filling General Polygon");
    AppendMenu(Filling_list, MF_STRING, 28, "Filling Convex Polygon");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)Filling_list, "Fillings");

    AppendMenu(clipping_list, MF_STRING, 29, "Clipping polygon with ractangle window");
    AppendMenu(clipping_list, MF_STRING, 30, "Clipping line with ractangle window");
    AppendMenu(clipping_list, MF_STRING, 31, "Clipping point with ractangle window");
    AppendMenu(clipping_list, MF_STRING, 32, "Clipping line with square window");
    AppendMenu(clipping_list, MF_STRING, 33, "Clipping point with square window");
    AppendMenu(list_, MF_POPUP, (UINT_PTR)clipping_list, "clipping");




    AppendMenu(Clear_list, MF_STRING, 34, "Clear");
    AppendMenu(Clear_list, MF_STRING, 35, "Save");
    AppendMenu(Clear_list, MF_STRING, 36, "Load");

    AppendMenu(list_, MF_POPUP, (UINT_PTR)Clear_list, "Clear");
...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case  (13):
            case_number = 13;
            cout << "You can Draw circle using Parametric Algorithm....." << endl;
            //-----------------------------------------------------------------
        case  (14):
            case_number = 14;
    ...
    case WM_RBUTTONDOWN:
        ...
        else if (case_number == 23 || case_number == 24) {
            x3 = LOWORD(lParam);
            y3 = HIWORD(lParam);
        ...
        else if (case_number == 25 || case_number == 26) {
        if (counter == 0) {
            x2 = LOWORD(lParam);
            y2 = HIWORD(lParam);
            R = Round(std::sqrt(std::pow(x2 - x1, 2.0) + pow(y2 - y1, 2.0)));
        ...
        { // general,convex polygon..
            ...
            else if (counter == 5 && case_number != 29)
            {
                if (case_number == 27)
